...
function generateContract(data) {
  ...
  const conditions = [
    ...
    'Governing Law: This agreement is governed by and construed in accordance with the laws of the State of Delaware, without regard to conflict of law principles. Any disputes shall be subject to the exclusive jurisdiction of the courts of the State of Delaware.',
